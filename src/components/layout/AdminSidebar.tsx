...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-48 flex-shrink-0 flex flex-col min-h-screen" style={{ background: '#3B1270' }}>
